								...
								<div class="card-body" style="padding: 5px !important;">
									<div class="row d-flex justify-content-between">
										...
										<div class="col-md-3">
											...
											<button type="submit" class="btn btn-success btn-xs agregarCarrito" style="height:25px !important; padding-top: 0px !important; margin:-30px;" imagen="http://cantaritos.test/Images/{{ $receta->Imagen }}" idProducto="{{ $receta->ID }}" idReceta="{{ $receta->ID }}" precio="{{ $receta->Costo }}" ingredientes="{{ $receta->Condimentos_Alternativos }}" cantidadArt="1" titulo="{{ $receta->Nombre }}"><i class="fas fa-plus"></i></button>
										</div>
									</div>
								</div>
							</div>
